...
class TestAccountsApi():
    ...
    def create_user_obj(self,is_verified=True):
        return User.objects.create_user(email='test@test.com', password='a/1234567', is_verified=is_verified)
    ...
    def test_password_reset_send_email_401_not_verified_user(self, api_client):
